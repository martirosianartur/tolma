...
const dummyMeals = [
  ...
  Meal(
    ...
    steps: [
      'Rinse the grape leaves in warm water.',
      'Chop the onions and parsley.',
      'Mix rice, ground beef, onions, and parsley in a bowl.',
      'Season with salt and pepper.',
      'Place a spoonful of the mixture on each grape leaf and roll tightly.',
      'Place the rolls in a pot, add water and olive oil, and simmer for 1 hour.',
  ...
  Meal(
    ...
    steps: [
      ...
      'Chop the potatoes, carrot, onion, and cabbage.',
      'Boil the beets in water for 30 minutes.',
      'Add the potatoes, carrot, and onion and cook for another 30 minutes.',
      'Add the cabbage and tomatoes and cook for 20 minutes.',
      'Season with salt and pepper.',
  ...
  Meal(
    ...
    steps: [
      'Mix flour, salt, and milk to form a dough.',
      'Let the dough rise for 1 hour.',
      'Roll out the dough and place the cheese in the center.',
      'Fold the dough over the cheese and form a boat shape.',
      'Bake at 200°C for 30 minutes.',
      'Crack an egg in the center and bake for another 5 minutes.',
  ...
  Meal(
    ...
    steps: [
      'Mix flour, eggs, and water to form a dough.',
      'Let the dough rest for 30 minutes.',
      'Mix ground pork, ground beef, chopped onion, salt, and pepper.',
      'Roll out the dough and cut into circles.',
      'Place a spoonful of meat mixture on each circle and fold into dumplings.',
  ...
  Meal(
    ...
    steps: [
      'Boil the lamb with salt and pepper for 2 hours.',
      'Remove the lamb and let it cool.',
      'Cook the noodles in the lamb broth.',
      'Slice the onions and add to the broth.',
      'Shred the lamb and place on top of the noodles.',
      'Serve with dill.'
    ],
    isGlutenFree: false,
    isVegan: false,
  ...
  Meal(
    ...
    steps: [
      ...
      'Pour into a greased cake tin and bake at 180°C for 45 minutes.',
      'Let the cake cool and cut in half horizontally.',
      'Spread apricot jam between the layers and on top.',
